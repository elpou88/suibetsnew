...
import { Gift, Users, Star, ArrowLeft, Check, Copy, Wallet, Coins } from "lucide-react";
            ...
            <Card className="bg-gradient-to-br from-cyan-900/30 to-blue-900/20 border-cyan-500/30">
              <CardContent className="p-5 flex items-center gap-4 flex-wrap">
                ...
                <div className="flex-1 min-w-[200px]">
                  <p className="text-white font-bold text-lg">SBETS Staking</p>
                  <p className="text-gray-400 text-sm">Earn 5% APY on your SBETS tokens. Staking has moved to its own dedicated page.</p>
                </div>
                <Button
                  variant="outline"
                  className="border-cyan-500/50 text-cyan-400"
                  onClick={() => setLocation('/staking')}
                  data-testid="btn-goto-staking"
                >
                  Go to Staking
                </Button>
              </CardContent>
